...
class CustomGradients {
  ...
  static List<Color> sweep = <Color>[const Color(0xFFa4edeb), const Color(0xFF00a9b5)];
  ...
  static List<Color> darken = [const Color(0xFF121212), const Color(0xFF121212)];
  static List<Color> dark = [const Color(0xff000000), const Color(0xff000000)];
